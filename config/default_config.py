...
DEFAULT_CONFIG = {
    ...
    # MCMC settings
    "mcmc": {
        "n_iterations": 100000,    # Total number of MCMC iterations to run
        ...
        "likelihood_sigma": 1,     # Standard deviation for Gaussian likelihood in log-space (equivalent to likelihood_scale)
